...
{
    public class ProviderApiAuthenticationAttribute : System.Web.Http.Filters.ActionFilterAttribute
    {
        public override void OnActionExecuting(System.Web.Http.Controllers.HttpActionContext actionContext)
        {
            ...
            else
            {
                ...
                var provider = db.Set<Provider>().FirstOrDefault(u => u.NetUserId == user.Id);
