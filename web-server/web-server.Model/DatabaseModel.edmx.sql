...
-- --------------------------------------------------
-- Date Created: 09/02/2017 23:04:46
-- Generated from EDMX file: C:\Users\Alek\Source\Repos\web-server\web-server.Model\DatabaseModel.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [aspnet-web-server-20161104122812];
GO
...
CREATE TABLE [dbo].[UserSet] (
    ...
    [NetUserId] nvarchar(max)  NOT NULL
);
GO
